<template>
  <aside id="sidebar" class="col-lg-2 col-sm-12 col-md-12 p-0">
    <nav id="nav" class="d-flex flex-column navbar-light navbar-expand-lg">
        ...
        <div class="d-flex collapse navbar-collapse align-items-start" id="navbarNav">
...
.navbar-light .navbar-brand { color: whitesmoke; }
